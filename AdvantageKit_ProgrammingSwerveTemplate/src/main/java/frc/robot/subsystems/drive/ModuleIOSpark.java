...
public class ModuleIOSpark implements ModuleIO {
  ...
  public ModuleIOSpark(int module) {
    ...
    turnController.enableContinuousInput(0, fullRotationRadians);
    ...
    turnPositionQueue =
        SparkOdometryThread.getInstance().registerSignal(turnSpark, this::getTurnAngleRadians);
  }

  private double getTurnAngleRadians() {
    double turnRad =
        ((turnEncoder.getAbsolutePosition().getValue().in(Units.Radians) % fullRotationRadians)
                + fullRotationRadians)
            % fullRotationRadians;
    return Rotation2d.fromRadians(turnRad).minus(zeroRotation).getRadians();
  }
  ...
  public void setTurnPosition(Rotation2d rotation) {
    ...
    double output = turnController.calculate(getTurnAngleRadians(), setpoint);
