...
public class AlignToReef extends SequentialCommandGroup {
        ...
        EndTarget pEndTarget)
    {
        ...
        super.addCommands(
            pathFindToPlace(), 
            new CloseUpOnReef(mSwerveSubsystem, findTargetPose(mEndTarget).transformBy(new Transform2d(0.25, -0.5, new Rotation2d())))
            );
    }
    ...
    private Command pathFindToPlace()
    {
        ...
        PathPlannerPath path = new PathPlannerPath(
            ...
            null,
            new GoalEndState(1, endingPose.getRotation())
        );
