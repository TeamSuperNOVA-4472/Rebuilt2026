...
public class CloseUpOnReef extends Command {
    ...
    public CloseUpOnReef(SwerveSubsystem pSwerveSubsystem, Pose2d pDestination)
    {
        ...
        mXPID = new ProfiledPIDController(5, 0, 0.01, new Constraints(1, 1));//(5, 0, 0.05);
        mYPID = new ProfiledPIDController(5, 0, 0.01, new Constraints(1, 1));
    ...
    public void initialize() {
        ...
        mXPID.reset(currentPose.getX());
        mYPID.reset(currentPose.getY());
    }
    ...
    public boolean isFinished() {
        return mXPID.atGoal() && mYPID.atGoal();
    }
}
